...
{
    % \begin{itemize}
    %     \item{Postponed due to Covid situation}
    % \end{itemize}
}
...
\cvitem{Machine Learning and Time Series Forecasting}{
...
%\cvitem{Web-Dev Languages,Libraries \& Frameworks:}
