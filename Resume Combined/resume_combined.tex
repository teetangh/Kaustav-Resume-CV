...
\begin{itemize}
    \item{\textbf{\large{Microsoft Student Partners-Machine Learning Internship}}}
          ...
          % \newline
          % \textit{- Performed Feature Engineering to detect the most important attributes of the dataset using Univariate and Multivariate Filtering techniques, Mutual Entropy Gain Filtering and also feature selection using RMSE Regression and ANOVA Test  }
          % \newline
...
\begin{itemize}
    \item{\textbf{\large{United Nations TakenMind - Global Data Analytics Internship}}}
          ...
          \newline
          \textit{- Implemented several boxplots,countplots,heatmaps on several datasets}
          \newline
          \textit{- Documentated several practical examples of Numpy and Pandas }
\end{itemize}
\begin{itemize}
...
\begin{itemize}
    ...
    \item{\textbf{Backtracking Algorithms}}
          ...
          \newline
          \textit{- Coded a \textbf{Sudoku Solver} that takes a partially filled 9*9 sudoku grid and outputs a solution so that every row, column and nine 3x3 subgrids contains exactly 1 instance of the digits from 1 to 9.}


    \item{\textbf{\large{Food Labs Robotics Startup Competition - ROS Engineer Role}}}
          \newline
